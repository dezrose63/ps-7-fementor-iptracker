...
I learned that I need a lot more practice with async Promises and API's. I also learned that even though some of these new frameworks seem like they would be the obvious go-to since they have everything I need in cone CLI cmd, I would have probablky had an easier time sticking with what I was familiar with. Even with all of the problems I encountered, I'm still glad I was able to get more experience with these new frameworks, and it's I can't wait to get more practice with coding in typescript, vite, tailwind, ect. 

I'm proud that I stuck with the React/Vite/Typescript/Tailwind setup and didn't revert back to vanilla HTML-CSS-Javascript.
...
- [Example resource 1] react.com - This helped me learn new concepts in an engaging way. 
- [Example resource 2] udemy.com/course/react-tutorial-and-projects-course - I really enjoyed taking this class, the instructor is very knowledgeable and really knows how to teach these often confusing concepts in a way that is easy to understand. 

## Author

- LinkedIn - [Desiree Rose](linkedin/in/dezrose)
- Frontend Mentor - [@dezrose63](https://www.frontendmentor.io/profile/dezrose63)
- GitHub - [@dezrose63](https://www.github.com/dezrose63
